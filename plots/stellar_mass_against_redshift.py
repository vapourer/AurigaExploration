...
class plot:
    def __init__(self,
        ...
        print('New stellar_mass_against_redshift plot')  
    ...
    def create(self) -> None:
        ...
        plt.legend()
        plt.title(f'Stellar mass against redshift for peak mass index {self.__peak_mass_index}')
        plt.savefig(f'./output/halo_6/stellar_mass_histories/MassRedshift_{self.__peak_mass_index}.png')
